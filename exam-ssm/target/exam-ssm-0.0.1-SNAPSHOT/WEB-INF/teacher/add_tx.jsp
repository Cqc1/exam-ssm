...
$(function(){
	$("#add").click(function() {
		...
		params.tixinid = $("#txid").val();	
		params.tixinname =$("#txname").val();		
			$.ajax({
				async:false,
				type: "POST",
				url: "${pageContext.request.contextPath}/teacher/addTx",//注意路径	
				...
				success:function(result) {
	                    ...
	                    if(message==null){
		                    ...
		                    alert("此题型已存在！");
		                    window.location.href="${pageContext.request.contextPath}/teacher/TxAdd_view";
	                    }
	                },
    ...
    <form method="post">
        <table width="100%" cellpadding="5" border="0" class="tm_table_form">
            ...
            <tr>
                <th>题型名称：</th>
                <td>
                    <input type="text" id="txname" class="tm_txt" size="50" maxlength="30">
                </td>
            </tr>       
            </tbody>
            <tfoot>
