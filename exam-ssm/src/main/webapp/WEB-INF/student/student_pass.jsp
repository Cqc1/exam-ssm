...
$(function(){
	...
	if (old_pass.value == "" || new_pass.value == ""||new_pass2.value=="") {
		...
		//检查旧密码是否正确
				...
				params.stuid=$("#stuid").html();
				params.new_pass=$("#new_pass").val();
		        $.ajax({
		        	async:true,
		            type:"post",
		            url:"${pageContext.request.contextPath}/student/Stu_pass",
		            datatype:"json",
		            data:params,
		            ...
		            success:function(result){    
	                    ...
	                    if(message=="success"){
		                    ...
		                    alert("密码输入错误！");
		                    window.location.href="${pageContext.request.contextPath}/student/student_pass.jsp";
	                    }
	                },
          ...
          <table width="100%" cellpadding="5" border="0" class="tm_table_form">
              <tbody>          
                  ...
                  <tr>
                     <th>旧密码：</th>
                     <td>
                       <input type="password" name="old_pass" id="old_pass" class="tm_txt" size="30" maxlength="30">
                     </td>
                  </tr>
                  <tr>
                      <th>新密码：</th>
                      <td>
                        <input type="password" name="new_pass" id="new_pass" class="tm_txt" size="30" maxlength="30">
                      </td>
                  </tr>
                  <tr>
                      <th>确认新密码：</th>
                      <td>
                        <input type="password" name="new_pass2" id="new_pass2" class="tm_txt" size="30" maxlength="30">
                      </td>
                  </tr>
              </tbody>
              <tfoot>
